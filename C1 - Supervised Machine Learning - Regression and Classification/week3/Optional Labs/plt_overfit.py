...
class overfit_example():
    ...
    def linear_regression(self):
        ...
        #linear_model = Ridge(alpha=self.lambda_, normalize=True, max_iter=10000) #normalize is depreciated
        linear_model = Ridge(alpha=self.lambda_, max_iter=10000) #LO added
